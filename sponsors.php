...
<ul><li>
<?php 
	$ban1 = get_option('uree_banner1'); 
	$url1 = get_option('uree_url1'); 
	$lab1 = get_option('uree_lab1'); 
	$alt1 = get_option('uree_alt1');
?>
...
<li>
<?php 
	$ban2 = get_option('uree_banner2'); 
	$url2 = get_option('uree_url2'); 
	$lab2 = get_option('uree_lab2'); 	
	$alt2 = get_option('uree_alt2');
?>
...
<li>
<?php 
	$ban3 = get_option('uree_banner3'); 
	$url3 = get_option('uree_url3'); 
	$lab3 = get_option('uree_lab3'); 
	$alt3 = get_option('uree_alt3');	
?>
...
<li>
<?php 
	$ban4 = get_option('uree_banner4'); 
	$url4 = get_option('uree_url4');
	$lab4 = get_option('uree_lab4'); 
	$alt4 = get_option('uree_alt4');	
?>
